...
\newacronym{cas}{CAs}{Conversational Agents}
...
% write about the preprocessing, with and without glove

% write about the models architectures , bidirectional, parameters
