...
class SentimentClassifier(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        lr_scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='max', factor=0.001, patience=5, verbose=True, min_lr=1e-7)
...
model = SentimentClassifier(num_words, filter_units, kernel_size, dropout, output_dim=100)
