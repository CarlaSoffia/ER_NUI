...
if train:
    ...
    version = version+1
    checkpoint = ModelCheckpoint("models/model_"+str(version)+".h5", monitor='val_loss', save_best_only=True, mode='min', verbose=1)
    # Compile the model
    ...
    model = keras.models.load_model("models/model_"+str(version)+".h5")    
    with open('tokenizer.pickle', 'rb') as handle:
        tokenizer = pickle.load(handle)
    text_sequence = tokenizer.texts_to_sequences(["Hoje estive a passear e a ver o sol"])
